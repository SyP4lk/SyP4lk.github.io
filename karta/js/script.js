...
if((width < 800) && (width > 546)){
        ...
        newTop =  parseInt($('.karta__active').eq(3).css('top'))-(newWidt*0.11);
         newLeft =  parseInt($('.karta__active').eq(3).css('left'))-(newWidt*0.2);
        $('.karta__active').eq(3).css({
            top: newTop,
            left: newLeft
        })
        newTop =  parseInt($('.karta__active').eq(4).css('top'))-(newWidt*0.15);
         newLeft =  parseInt($('.karta__active').eq(4).css('left'))-(newWidt*0.1);
        $('.karta__active').eq(4).css({
            top: newTop,
            left: newLeft
        })
        newTop =  parseInt($('.karta__active').eq(5).css('top'))-(newWidt*0.17);
         newLeft =  parseInt($('.karta__active').eq(5).css('left'))-(newWidt*0.1);
        ...
        newTop =  parseInt($('.karta__active').eq(7).css('top'))-(newWidt*0.12);
         newLeft =  parseInt($('.karta__active').eq(7).css('left'))-(newWidt*0.4);
